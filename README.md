...
- [kadec0 x402 Scrapers](https://api.kadec0.xyz) - 30 pay-per-call web-data and scraper endpoints for AI agents. Crypto and DeFi market data (DeFi TVL, stablecoin supply, yield pools, token prices, trending coins, Ethereum gas oracle), SEC EDGAR filings, congressional stock trades, GitHub/Hacker News/Stack Overflow, URL-to-markdown scrape, SERP web search, WHOIS/DNS and bulk domain intel, company enrichment, X/Twitter reads, plus civic/health/academic feeds (FDA, CVE, recalls, building permits, arXiv/PubMed). $0.005–$0.15 USDC per call on Base. Keyless Coinbase CDP facilitator, settles direct to wallet, no accounts, no signup. ([Discovery](https://api.kadec0.xyz/.well-known/x402)) ([OpenAPI](https://api.kadec0.xyz/openapi.json)) ([Docs](https://api.kadec0.xyz/docs))
### Games & On-Chain Apps
